...
__________________
Le problème est un problème de régression sur des donnees sequentielles.
...
# Ici Le notebook essaie plusieurs noms de fichier pour éviter les blocages inutile.
possible_files = [
...
df = df.sort_values(["battery_id", "cycle_number", "SoC"], ascending=[True, True, False]).copy()
print("Tri des données effectué.")
...
# On ajuste juste les scalers uniquement sur le train
